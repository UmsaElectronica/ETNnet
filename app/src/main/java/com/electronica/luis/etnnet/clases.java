...
public class clases extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.clases,container,false);
        listview=(ListView)v.findViewById(R.id.claseslist);
        descargarimagen();
        return v;
    }
    private void descargarimagen(){
        ...
        cliente.get("http://www.electronica.umsa.bo/sistcomunicados/webservices/clases.php?x="+sem, new AsyncHttpResponseHandler() {
            @Override
