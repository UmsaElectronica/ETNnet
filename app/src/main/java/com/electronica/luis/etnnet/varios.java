 ...
 */
public class varios extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.varios,container,false);
        listview=(ListView)v.findViewById(R.id.varioslist);
        descargarimagen();
        return v;
    }
    private void descargarimagen(){
        ...
        cliente.get("http://www.electronica.umsa.bo/sistcomunicados/webservices/varios.php?x="+sem, new AsyncHttpResponseHandler() {
            @Override
                ...
                if (statusCode == 200) {
                    ...
                    try {
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            cuerpo.add(jsonArray.getJSONObject(i).getString("cuerpo"));
